package com.android.videoplayer.media.help;
...
public class ExoMediaSourceHelper {
    ...
    public static ExoMediaSourceHelper getInstance() {
        if (sInstance == null) {
            synchronized (ExoMediaSourceHelper.class) {
                if (sInstance == null) {
                    sInstance = new ExoMediaSourceHelper();
                }
            }
        }
        return sInstance;
    ...
    private DataSource.Factory getDataSourceFactory() {
        return new DefaultDataSourceFactory(App.getInstance().getContext(), getHttpDataSourceFactory());
    }
