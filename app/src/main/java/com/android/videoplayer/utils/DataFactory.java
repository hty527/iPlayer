...
public class DataFactory {
    ...
    public List<Menu> getMenus() {
        ...
        menus.add(new Menu(getString(R.string.text_item_resouce,"Assets/Raw本地资源播放"),5,null,2));
        menus.add(new Menu(getString(R.string.text_item_continuity,"连续播放一个视频列表"),6,null,1));
        menus.add(new Menu(getString(R.string.text_item_auto,"列表自动播放(无缝转场)"),7,getString(R.string.text_item_sub_list,"列表"),0));
        menus.add(new Menu(getString(R.string.text_item_click,"列表点击播放(无缝转场)"),8,null,1));
        menus.add(new Menu(getString(R.string.text_item_window,"Activity悬浮窗"),9,getString(R.string.text_item_sub_window,"窗口"),0));
        menus.add(new Menu(getString(R.string.text_item_goable_window,"全局悬浮窗"),10,null,2));
        menus.add(new Menu(getString(R.string.text_item_window_open,"任意界面开启窗口播放器"),11,null,2));
        menus.add(new Menu(getString(R.string.text_item_window_goable_open,"任意界面开启全局悬浮窗播放器"),12,null,2));
        menus.add(new Menu(getString(R.string.text_item_dip,"画中画(Android8.0+)"),13,null,1));
        menus.add(new Menu(getString(R.string.text_item_dy,"仿抖音(扩展示例)"),14,getString(R.string.text_item_sub_expand,"扩展"),0));
        menus.add(new Menu(getString(R.string.text_item_danmu,"自定义弹幕控制器(扩展示例)"),15,null,1));
        menus.add(new Menu(getString(R.string.text_item_home,"项目主页"),16,getString(R.string.text_item_sub_other,"其它"),3));
