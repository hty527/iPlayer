package com.android.videoplayer.cache;
 ...
 * created by hty
 * 2022/7/11
 * Desc:抖音预加载工具，使用AndroidVideoCache实现
 */
public class PreloadManager {
    ...
    public void addPreloadTask(String rawUrl, int position) {
        ...
        Logger.d(TAG,"addPreloadTask: " + position);
    ...
    public void pausePreload(int position, boolean isReverseScroll) {
        Logger.d(TAG,"pausePreload：" + position + " isReverseScroll: " + isReverseScroll);
    ...
    public void resumePreload(int position, boolean isReverseScroll) {
        Logger.d(TAG,"resumePreload：" + position + " isReverseScroll: " + isReverseScroll);
